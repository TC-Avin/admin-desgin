    ...
    return (
        <>
            ...
            <Dropdown.Menu className="dropdown-menu">
                <Dropdown.Item className="dropdown-item">Daily</Dropdown.Item>
                <Dropdown.Item className="dropdown-item">Weekly</Dropdown.Item>
                <Dropdown.Item className="dropdown-item">Monthly</Dropdown.Item>
            </Dropdown.Menu>
        </Dropdown>
        </>
    )
