            ...
            <div className="table-responsive">
              <div id="job_data" className="dataTables_wrapper">
                ...
                >
                  <thead>
                    <tr role="row">
                      <th className="sorting_asc" style={{ width: "70px" }}>
                        List ID
                      </th>
                      <th className="sorting" style={{ width: "200px" }}>
                        List Name
                      </th>
                      <th className="sorting" style={{ width: "170px" }}>
                        Contacts{" "}
                      </th>
                      <th className="sorting" style={{ width: "40px" }}>
                        CREATED BY
                      </th>
                      <th className="sorting" style={{ width: "40px" }}>
                        UPLOAD DATE{" "}
                  ...
                  <tbody>
                    <tr className="odd" role="row">
                      ...
                      <td className="p-3">Accountant</td>
                      <td className="p-3">25484548652564</td>
                      <td className="p-3">2008/11/28</td>
                    ...
                    <tr className="odd" role="row">
                      <td className="sorting_1" className="p-3">
                        cat-112
                      </td>
                      <td className="p-3">Accountant</td>
                      <td className="p-3">2008/11/28</td>
