							...
							<div className="card-tabs mt-3 mt-sm-0 mb-xxl-0 mb-4">
								<Nav as="ul" className="nav nav-tabs">
									<Nav.Item as="li" className="nav-item">
										<Nav.Link className="nav-link" eventKey="Free">Free Users</Nav.Link>
									</Nav.Item>
									<Nav.Item as="li" className="nav-item">
										<Nav.Link className="nav-link" eventKey="Premium">Premium Users</Nav.Link>
									</Nav.Item>
									<Nav.Item as="li" className="nav-item">
										<Nav.Link className="nav-link" eventKey="Personalized">Personalized Users</Nav.Link>
									</Nav.Item>
								</Nav>
							</div>
                            <Link onClick={()=> setaddCompanyModal(true)} className="btn btn-primary mb-xxl-0 mb-4 ">
												...
												<tr role="row" className="odd">
													...
													<td>
														<div>
															...
															<i class="fa fa-circle text-success me-1"></i>Free
															</h5>
														</div>
													</td>
													<td>
													...
													<td>
                                                        <Link to={"#"} className="me-2 btn btn-warning light" title="Edit">
														<i className="fa fa-edit"></i>
														</Link>
														<Link to={"#"} className="me-2 btn btn-danger light" title="Block">
														<i className="fa fa-ban"></i>
														</Link>
														<Link to={"/companyprofile"} className="me-2 btn btn-primary light" title="View">
							...
							<form >
								...
								<div className="modal-body" style={{padding: 0}}>
									...
									<div className="add-contact-box">
										...
										<div className="card overflow-hidden" style={{borderRadius: 0, boxShadow: 'none'}}>
											<div
									...
									<div className="card" style={{boxShadow: 'none'}}>
                                        ...
                                        <div className="basic-form">
                                            ...
                                            {({
                                                ...
                                                >
                                                    <label className="text-label">No. of Credits</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
												...
												{(values.subscription === "Personalized") &&
													...
													>
                                                    <label className="text-label">Per Credit Cost</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                        <i className="fa fa-comment-dollar" />{" "}
                                                        </span>
                                                    ...
                                                    <div
                                                        ...
                                                        style={{ display: "block" }}
                                                    >
                                                        {errors.perCreditCost && errors.perCreditCost}
                                                    </div>
                                                ...
                                                >
                                                    <label className="text-label">No. of Team Members</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                        <i className="fa fa-comment-dollar" />{" "}
                                                        </span>
                                                ...
                                                >
                                                    <label className="text-label">Cost of each Team Member</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                        <i className="fa fa-comment-dollar" />{" "}
                                                        </span>
                                                    ...
                                                    <div
                                                        ...
                                                        style={{ display: "block" }}
                                                    >
                                                        {errors.teamMemberCost && errors.teamMemberCost}
                                                    </div>
                                                ...
                                                >
                                                    <label className="text-label">Billing Cycle</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                        <i className="fa fa-users" />{" "}
                                                        </span>
                                                ...
                                                >
                                                    <label className="text-label">Choose Subscription</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                ...
                                                >
                                                    <label className="text-label">Subscription Package Cost</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                        <i className="fa fa-comment-dollar" />{" "}
                                                        </span>
                                                    ...
                                                    <div
                                                        ...
                                                        style={{ display: "block" }}
                                                    >
                                                        {errors.subscriptionPackageCost && errors.subscriptionPackageCost}
                                                    </div>
                                                ...
                                                >
                                                    <label className="text-label">Total Payble Amount</label>
                                                    <div className="input-group">
                                                        <span className="input-group-text">
                                                        <i className="fa fa-comment-dollar" />{" "}
                                                        </span>
                                                    ...
                                                    <div
                                                        ...
                                                        style={{ display: "block" }}
                                                    >
                                                        {errors.totalPaybleAmount && errors.totalPaybleAmount}
                                                    </div>
